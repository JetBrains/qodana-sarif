...
public class OldCalculation {
    ...
    private OldCalculation(Options options) {
        this.options = options;
    }

    public static OldCalculation compare(SarifReport report, SarifReport baseline, Options options) {
        OldCalculation result = new OldCalculation(options);
        result.fillBaselineState(report, baseline);

        return result;
    }

    public static OldCalculation compare(SarifReport report, SarifReport baseline) {
