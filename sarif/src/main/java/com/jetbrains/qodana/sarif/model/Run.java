...
public class Run {
    ...
    public boolean equals(Object other) {
        ...
        Run rhs = ((Run) other);
        return ((((((((((((((((((((((((((((Objects.equals(this.addresses, rhs.addresses)) && (Objects.equals(this.logicalLocations, rhs.logicalLocations))) && (Objects.equals(this.policies, rhs.policies))) && (Objects.equals(this.language, rhs.language))) && (Objects.equals(this.invocations, rhs.invocations))) && (Objects.equals(this.graphs, rhs.graphs))) && (Objects.equals(this.baselineGuid, rhs.baselineGuid))) && (Objects.equals(this.translations, rhs.translations))) && (Objects.equals(this.newlineSequences, rhs.newlineSequences))) && (Objects.equals(this.webResponses, rhs.webResponses))) && (Objects.equals(this.externalPropertyFileReferences, rhs.externalPropertyFileReferences))) && (Objects.equals(this.defaultSourceLanguage, rhs.defaultSourceLanguage))) && (Objects.equals(this.webRequests, rhs.webRequests))) && (Objects.equals(this.results, rhs.results))) && (Objects.equals(this.automationDetails, rhs.automationDetails))) && (Objects.equals(this.conversion, rhs.conversion))) && (Objects.equals(this.artifacts, rhs.artifacts))) && (Objects.equals(this.originalUriBaseIds, rhs.originalUriBaseIds))) && (Objects.equals(this.specialLocations, rhs.specialLocations))) && (Objects.equals(this.defaultEncoding, rhs.defaultEncoding))) && (Objects.equals(this.tool, rhs.tool))) && (Objects.equals(this.versionControlProvenance, rhs.versionControlProvenance))) && (Objects.equals(this.runAggregates, rhs.runAggregates))) && (Objects.equals(this.redactionTokens, rhs.redactionTokens))) && (Objects.equals(this.taxonomies, rhs.taxonomies))) && (Objects.equals(this.columnKind, rhs.columnKind))) && (Objects.equals(this.threadFlowLocations, rhs.threadFlowLocations))) && (Objects.equals(this.properties, rhs.properties)));
    }
