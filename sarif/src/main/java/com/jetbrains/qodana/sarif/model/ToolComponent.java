...
public class ToolComponent {
    ...
    public boolean equals(Object other) {
        ...
        return ((((((((((((((((((((((((((((Objects.equals(this.releaseDateUtc, rhs.releaseDateUtc)) && (Objects.equals(this.rules, rhs.rules))) && (Objects.equals(this.language, rhs.language))) && (Objects.equals(this.downloadUri, rhs.downloadUri))) && (Objects.equals(this.supportedTaxonomies, rhs.supportedTaxonomies))) && (Objects.equals(this.fullDescription, rhs.fullDescription))) && (Objects.equals(this.informationUri, rhs.informationUri))) && (Objects.equals(this.associatedComponent, rhs.associatedComponent))) && (Objects.equals(this.translationMetadata, rhs.translationMetadata))) && (Objects.equals(this.productSuite, rhs.productSuite))) && (Objects.equals(this.taxa, rhs.taxa))) && (Objects.equals(this.product, rhs.product))) && (Objects.equals(this.isComprehensive, rhs.isComprehensive))) && (Objects.equals(this.minimumRequiredLocalizedDataSemanticVersion, rhs.minimumRequiredLocalizedDataSemanticVersion))) && (Objects.equals(this.fullName, rhs.fullName))) && (Objects.equals(this.shortDescription, rhs.shortDescription))) && (Objects.equals(this.version, rhs.version))) && (Objects.equals(this.globalMessageStrings, rhs.globalMessageStrings))) && (Objects.equals(this.localizedDataSemanticVersion, rhs.localizedDataSemanticVersion))) && (Objects.equals(this.dottedQuadFileVersion, rhs.dottedQuadFileVersion))) && (Objects.equals(this.contents, rhs.contents))) && (Objects.equals(this.organization, rhs.organization))) && (Objects.equals(this.name, rhs.name))) && (Objects.equals(this.semanticVersion, rhs.semanticVersion))) && (Objects.equals(this.guid, rhs.guid))) && (Objects.equals(this.locations, rhs.locations))) && (Objects.equals(this.notifications, rhs.notifications))) && (Objects.equals(this.properties, rhs.properties)));
    }
